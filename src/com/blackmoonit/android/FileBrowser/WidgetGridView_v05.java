...
public class WidgetGridView_v05 extends WidgetGridView_v03 {

	public WidgetGridView_v05(Context aContext) {
		super(aContext);
	}

	public WidgetGridView_v05(Context aContext, AttributeSet attrs) {
		super(aContext,attrs);
	}

	public WidgetGridView_v05(Context aContext, AttributeSet attrs, int defStyle) {
